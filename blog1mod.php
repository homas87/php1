                    ...
                    <div class="contact-form-area">
                        <form action="_blog1mod.php" method="post">
                            ...
                            <input name="no" type="hidden" value="<?=$mod['no'];?>"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input name="category" type="text" class="form-control"  placeholder="카테고리를 작성해 주세요" value="<?=$mod['title']; ?>" >
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea name="content" class="form-control" cols="30" rows="10" placeholder="본문을 작성해주세요"><?=$mod['title']; ?> </textarea>
                                    </div>
                                </div>
